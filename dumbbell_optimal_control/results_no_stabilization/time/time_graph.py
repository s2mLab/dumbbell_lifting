...
class ResultFile(Enum):
    ...
    FULL_WINDOW_FATIGUE_TORQUE = "FULL_WINDOW_FATIGUE_TORQUE_NO_STABILIZATION_20_$TauXia_all$.csv"
    FULL_WINDOW_ONLY_FATIGUE = "FULL_WINDOW_ONLY_FATIGUE_NO_STABILIZATION_17_$TauXia_mf$.csv"
    FULL_WINDOW_ONLY_TORQUE = "FULL_WINDOW_ONLY_TORQUE_NO_STABILIZATION_14_$TauXia_tau$.csv"
