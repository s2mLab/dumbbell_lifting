...
class ResultFile(Enum):
    NMPC_FATIGUE_TORQUE = "CONDITIONS_FATIGUE_TORQUE_WITH_STABILIZATION_21_$TauXia_all$.csv"
    NMPC_ONLY_FATIGUE = "CONDITIONS_ONLY_FATIGUE_WITH_STABILIZATION_20_$TauXia_mf$.csv"
    NMPC_ONLY_TORQUE = "CONDITIONS_ONLY_TORQUE_WITH_STABILIZATION_9_$TauXia_tau$.csv"
    FULL_WINDOW_FATIGUE_TORQUE = "FULL_WINDOW_FATIGUE_TORQUE_WITH_STABILIZATION_20_$TauXia_all$.csv"
    FULL_WINDOW_ONLY_FATIGUE = "FULL_WINDOW_ONLY_FATIGUE_WITH_STABILIZATION_17_$TauXia_mf$.csv"
    FULL_WINDOW_ONLY_TORQUE = "FULL_WINDOW_ONLY_TORQUE_WITH_STABILIZATION_14_$TauXia_tau$.csv"
...
for i, result_file in enumerate(ResultFile):
    ...
    try:
        if "FATIGUE_TORQUE" in result_file.value:
            ...
            # data_df1[row_idx, 0] = sum(data["time"] ) / nb_cycles
